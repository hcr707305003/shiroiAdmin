...
) ENGINE = InnoDB AUTO_INCREMENT = 73 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '后台菜单' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of admin_menu
-- ----------------------------
INSERT INTO `admin_menu` VALUES (1, '2bdc352555de1f79b63fb3deeaf59364', 0, '后台首页', 'admin/index/index', 'fas fa-home', 1, 1, 1, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (2, '5d7748f7c87b8d1f255b3f19aa305616', 0, '系统管理', 'admin/system/manage', 'fas fa-desktop', 1, 1, 2, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (3, '6917812d7be49b6a8b0016d1ae055717', 2, '用户管理', 'admin/admin_user/index', 'fas fa-user', 1, 0, 3, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (4, '142bf4c96973d197fc74c20ec8467d64', 3, '添加用户', 'admin/admin_user/add', 'fas fa-plus', 0, 0, 4, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (5, 'b841fd5835d55b02ca371dac2f3cd307', 3, '修改用户', 'admin/admin_user/edit', 'fas fa-edit', 0, 0, 5, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (6, '858e464d6e6ef68b201043b5a9a570bc', 3, '删除用户', 'admin/admin_user/del', 'fas fa-close', 0, 0, 6, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (7, '0c4c70a18743ddeb48ff3a8519a86004', 2, '角色管理', 'admin/admin_role/index', 'fas fa-user-friends', 1, 0, 7, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (8, 'c669425ed1b1afc0f83fcf431ea017b7', 7, '添加角色', 'admin/admin_role/add', 'fas fa-plus', 0, 0, 8, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (9, '8b805c75cddcb84f74eb6cadf84a52c3', 7, '修改角色', 'admin/admin_role/edit', 'fas fa-edit', 0, 0, 9, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (10, 'ded49e882d6f5ffebbab14e1260fa0c7', 7, '删除角色', 'admin/admin_role/del', 'fas fa-close', 0, 0, 10, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (11, '243ddec28fd0d5a0a7a36b33975cb13b', 7, '角色授权', 'admin/admin_role/access', 'fas fa-key', 0, 0, 11, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (12, '5127f643ea3865a2b7f7dec39e594b81', 2, '菜单管理', 'admin/admin_menu/index', 'fas fa-align-justify', 1, 0, 12, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (13, '373672f8a6252a201463467221f0fa45', 12, '添加菜单', 'admin/admin_menu/add', 'fas fa-plus', 0, 0, 13, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (14, 'd8ba3666bfb5375d0c7e597c9c54eeb1', 12, '修改菜单', 'admin/admin_menu/edit', 'fas fa-edit', 0, 0, 14, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (15, '8ed4301aa0ba437d6fb1f83f7d131252', 12, '删除菜单', 'admin/admin_menu/del', 'fas fa-close', 0, 0, 15, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (16, '3430eac7d2f1944fc86a8136bed06498', 2, '操作日志', 'admin/admin_log/index', 'fas fa-keyboard', 1, 0, 16, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (17, '801c38276dc01383e42014e81102978c', 16, '查看操作日志详情', 'admin/admin_log/view', 'fas fa-search-plus', 0, 0, 17, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (18, 'cd04f7ed665c54943022890976f6b049', 2, '个人资料', 'admin/admin_user/profile', 'fas fa-smile', 1, 0, 18, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (19, 'bc4b17293d0f71a9ae7854dec9151456', 2, '开发管理', 'admin/develop/manager', 'fas fa-code', 1, 0, 32, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (20, '7471730ae47ed85278b99c74ba46af09', 19, '代码生成', 'admin/generate/index', 'fas fa-file-code', 1, 0, 33, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (21, '955e1b95497a1ad613c95fe316aa8ece', 19, '设置配置', 'admin/develop/setting', 'fas fa-cogs', 1, 0, 34, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (22, '4f87cb5f31a72392730144f2f917bb47', 21, '设置管理', 'admin/setting/index', 'fas fa-cog', 1, 0, 35, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (23, '404d51cb6332bf25f8fa87c3a906871d', 22, '添加设置', 'admin/setting/add', 'fas fa-plus', 0, 0, 36, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (24, '1d4638fb966c3b6115a769832ce0da3e', 22, '修改设置', 'admin/setting/edit', 'fas fa-pencil', 0, 0, 37, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (25, '48cf4299ada39b97b247714bbf1cee01', 22, '删除设置', 'admin/setting/del', 'fas fa-trash', 0, 0, 38, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (26, 'de5a2d57136fea1fe79f0c303cb15687', 21, '设置分组管理', 'admin/setting_group/index', 'fas fa-list', 1, 0, 39, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (27, '31b4635f28e072bcd3d1bc4681ed2558', 26, '添加设置分组', 'admin/setting_group/add', 'fas fa-plus', 0, 0, 40, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (28, '0a49b62b71fc342a9dfd43e8a129c6a5', 26, '修改设置分组', 'admin/setting_group/edit', 'fas fa-pencil', 0, 0, 41, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (29, 'bd66d7868f663ece4a8a17e109fdcd1d', 26, '删除设置分组', 'admin/setting_group/del', 'fas fa-trash', 0, 0, 42, 'POST', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (30, '49ea0b23b38f72030860bd2f54879c3d', 19, '数据维护', 'admin/database/table', 'fas fa-database', 1, 0, 49, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (31, '478acde145fa45266afe9f2108f1cc40', 30, '查看表详情', 'admin/database/view', 'fas fa-eye', 0, 0, 50, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (32, '4cc96ac1de1196f78a1a4d8dce00af45', 30, '优化表', 'admin/database/optimize', 'fas fa-refresh', 0, 0, 51, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (33, 'a274e7f296c3fc4095607f82e97fda3d', 30, '修复表', 'admin/database/repair', 'fas fa-circle-o-notch', 0, 0, 52, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (34, 'ef00ddf9220bffe2d265e8b7d7f89655', 0, '用户管理', 'admin/user/manage', 'fas fa-users', 1, 0, 19, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (35, '632dc8b225070beba5d1f3f5c1d27f84', 34, '用户管理', 'admin/user/index', 'fas fa-user', 1, 0, 20, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (36, '5ef00dbcb0b831f13dfe4cbe5a23f2b8', 35, '添加用户', 'admin/user/add', 'fas fa-plus', 0, 0, 21, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (37, '6a8a61e862251b74665d9ad44e47f19d', 35, '修改用户', 'admin/user/edit', 'fas fa-pencil', 0, 0, 22, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (38, '27d99f3f509b07c0de6438394db5f4b9', 35, '删除用户', 'admin/user/del', 'fas fa-trash', 0, 0, 23, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (39, 'cde742fa779d8b19bf7b37b23d26e507', 35, '启用用户', 'admin/user/enable', 'fas fa-circle', 0, 0, 24, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (40, 'befa3cfd961faaab2d66261cf3876a14', 35, '禁用用户', 'admin/user/disable', 'fas fa-circle', 0, 0, 25, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (41, '4195e837120f302e887e0f8b524d8926', 34, '用户等级管理', 'admin/user_level/index', 'fas fa-th-list', 1, 0, 26, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (42, '9c2809cb12871eddee1f2459ab01c40e', 41, '添加用户等级', 'admin/user_level/add', 'fas fa-plus', 0, 0, 27, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (43, 'edbed8be8c5accac618feff257879295', 41, '修改用户等级', 'admin/user_level/edit', 'fas fa-pencil', 0, 0, 28, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (44, 'e45efee22659e4e153e7e51e5a165771', 41, '删除用户等级', 'admin/user_level/del', 'fas fa-trash', 0, 0, 29, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (45, 'b1659dd053e84179c953e2a385202468', 41, '启用用户等级', 'admin/user_level/enable', 'fas fa-circle', 0, 0, 30, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (46, '5ad612c6f5278b43b08ec350b090a775', 41, '禁用用户等级', 'admin/user_level/disable', 'fas fa-circle', 0, 0, 31, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (47, '7223559326415427ac5f82b9cf3293cb', 0, '设置中心', 'admin/setting/center', 'fas fa-cogs', 1, 0, 43, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (48, '09cd01e1a49fd349d14e988161c67028', 47, '所有配置', 'admin/setting/all_setting', 'fas fa-list', 1, 0, 44, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (49, 'a1c0b090ecf614077a64db5ea9556b50', 47, '后台设置', 'admin/setting/admin_setting', 'fas fa-adjust', 1, 0, 45, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (50, '45f4f18941c4b3dd23b60cefbe12f271', 47, '前台设置', 'admin/setting/index_setting', 'fas fa-user', 1, 0, 45, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (51, '764bfabdf87f4aeb2ba8e621d822ac28', 47, '对象存储设置', 'admin/setting/cloud_setting', 'fas fa-cloud', 1, 0, 45, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (52, '1c99b060340fb0dbf9efa97b8e049e74', 47, '微信设置', 'admin/setting/wechat_setting', 'fas fa-comment', 1, 0, 45, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (53, 'd7a620fdfc6f9a4a915161e47bb762fd', 47, '基本设置', 'admin/setting/config_setting', 'fas fa-wrench', 1, 0, 45, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (54, 'd12fc5597092044afd9d8c5200c13e11', 47, '更新设置', 'admin/setting/update', 'fas fa-pencil', 0, 0, 46, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (55, 'b54d56991fbb6f85749ad93a4c96af13', 0, '通用操作', 'admin/common/option', 'fas fa-list', 0, 0, 53, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (56, 'd33f670c0c61632a4d0e18fefd7d9414', 55, '表单上传文件', 'admin/file/upload', 'fas fa-cloud-upload-alt', 0, 0, 54, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (57, 'fa7cd7a748ed06c8740f53a6f001090c', 55, '编辑器上传文件', 'admin/file/editor', 'fas fa-upload', 0, 0, 55, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (58, '74a776b3cc7eff052c6efb75ac6e2e7f', 0, '测试案例', 'admin/common/option', 'fas fa-list', 1, 0, 1000, '不记录', 1693360003, 1693360003, 0);
INSERT INTO `admin_menu` VALUES (59, 'aeb5a7a8dce390032e602493c7e69c53', 58, '测试案例（一）', 'admin/test/index', 'fas fa-list', 1, 0, 1000, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (60, '7836746fdd50bd2f6d7dc6fe9e6f0514', 59, '添加测试', 'admin/test/add', 'fas fa-plus', 0, 0, 1000, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (61, 'c50412c1e45a95c1eacc78bc113a39c7', 59, '修改测试', 'admin/test/edit', 'fas fa-pencil', 0, 0, 1000, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (62, '772290fe9011b5759615b971ed73ee25', 59, '删除测试', 'admin/test/del', 'fas fa-trash', 0, 0, 1000, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (63, '2860f507f08c33d1e8e878a5d20be722', 59, '启用测试', 'admin/test/enable', 'fas fa-circle', 0, 0, 1000, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (64, '6564d7c65ee599df4f9829d4ac340e16', 59, '禁用测试', 'admin/test/disable', 'fas fa-circle', 0, 0, 1000, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (65, '6aef96bcb7d4eca7262b03311fa5c69b', 58, '测试案例（二）', 'admin/test1/index', 'fas fa-list', 1, 0, 1000, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (66, '3028506aa38d1bbdc60889c6792994e3', 65, '添加测试', 'admin/test1/add', 'fas fa-plus', 0, 0, 1000, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (67, '0ca081d589f922266bbe8997fbaecd96', 65, '修改测试', 'admin/test1/edit', 'fas fa-pencil', 0, 0, 1000, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (68, '2f080985c5e33ded7b45e4015481efb2', 65, '删除测试', 'admin/test1/del', 'fas fa-trash', 0, 0, 1000, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (69, '289b26ef53874fededf7ac7a41f3dcdb', 65, '启用测试', 'admin/test1/enable', 'fas fa-circle', 0, 0, 1000, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (70, '02fc5c7f3bf8f7c63368dd080487acff', 65, '禁用测试', 'admin/test1/disable', 'fas fa-circle', 0, 0, 1000, 'POST', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (71, 'e8380f3dec996b792cdd13d1b9bf3e7f', 58, '测试案例（三）', 'admin/form_design/index', 'fas fa-list', 1, 0, 1000, '不记录', 1693360004, 1693360004, 0);
INSERT INTO `admin_menu` VALUES (72, '48e917f02d24ca47a0ec84868286c149', 71, '表单设计页', 'admin/form_design/design', 'fa-pencil-alt', 0, 0, 1000, '不记录', 1693360004, 1693360004, 0);
...
-- ----------------------------
INSERT INTO `admin_role` VALUES (1, '管理员', '后台管理员角色', '16,17,13,15,14,12,11,8,10,9,7,4,6,5,3,18,55,58,32,33,30,31,19,21,57,56,72,71,20,1,27,29,28,26,23,49,48,47,51,53,25,24,22,50,54,52,2,60,62,64,61,63,59,66,68,70,67,69,65,42,44,46,43,45,41,36,38,40,37,39,35,34', 1, 1692154607, 1692154607, 0);
