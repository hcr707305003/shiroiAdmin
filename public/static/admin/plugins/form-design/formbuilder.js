...
(function() {
	var BuilderView, EditFieldView, Formbuilder, FormbuilderCollection, FormbuilderModel, ViewFieldView, _ref, _ref1, _ref2, _ref3, _ref4, __hasProp = {}.hasOwnProperty,
...
(function() {
	Formbuilder.registerField('text', {
		...
		addButton: "<span class='symbol'><span class='fa fa-font'></span></span> 单行文字",
...
(function() {
	Formbuilder.registerField('phone', {
		order: 40,
		view: "<input type='text' placeholder='请填写手机号码' />",
		edit: "",
		addButton: "<span class=\"symbol\"><span class=\"fa fa-link\"></span></span> 手机"
	});
...
this["Formbuilder"]["templates"]["edit/min_max"] = function(obj) {
	...
	var __t, __p = '',
		__e = _.escape;
	with(obj) {
		__p += '<div class=\'fb-edit-section-header\'>最小值 / 最大值</div>\n\n下限值\n<input type="text" data-rv-input="model.' + ((__t = (Formbuilder.options.mappings.MIN)) == null ? '' : __t) + '" style="width: 30px" />\n\n&nbsp;&nbsp;\n\n上限值\n<input type="text" data-rv-input="model.' + ((__t = (Formbuilder.options.mappings.MAX)) == null ? '' : __t) + '" style="width: 30px" />\n';
